describe('The setting bill factory function', function(){
  ...
  describe('call and sms values', function(){
     ...
     it('It should be able to send 4 sms\'s at 0.99c each & return the total', function(){
      ...
      it('It should be able to make 4 sms at 1.31 each and make 4 calls at 3.73 each call & return the overrall total', function(){
          let billSetting = settingBillFunc();
  ...
  describe('warning and critical level ', function(){
      it('It should return thewarning class if the total reaches the warning level', function(){
          let billSetting = settingBillFunc();
      ...
      it('It update the warning & critical level', function(){
          let billSetting = settingBillFunc();
